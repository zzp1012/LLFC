...
def train(save_path: str,
    ...
    Args:
        ...
        step_size: the step size for the scheduler
    ...
    fir_seeds = random.Random(fir_seed).sample(range(10000000), k=epochs)
    sec_seeds = random.Random(sec_seed).sample(range(10000000), k=epochs)
    seeds = np.append(np.array(fir_seeds)[:midpoint], np.array(sec_seeds)[midpoint:])
...
def add_args() -> argparse.Namespace:
    ...
    parser.add_argument("--step_size", default=[80, 120], type=int, nargs="+",
                        help="set the StepLR stepsize")
    parser.add_argument("--steps_saving", default=40, type=int,
    ...
    parser.add_argument("--sec_seed", default=1, type=int,
                        help="set the seed for the second phase.")
    parser.add_argument("--midpoint", default=5, type=int,
